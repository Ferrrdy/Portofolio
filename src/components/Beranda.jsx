        ...
        <div className="grid md:grid-cols-2 items-center gap-12">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/assets/CV/CV FERDY ASHARI PUTRA.pdf" download className="bg-zinc-700 text-white py-3 px-6 rounded-lg font-semibold hover:bg-zinc-600 transition-colors flex items-center gap-2">
